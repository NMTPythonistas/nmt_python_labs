...
\subsection{Printing Using \protect\pythoninline{__str__(self)}}
...
Try running the above code. It should print out \pythoninline{"Test with x = 5"}.
Overriding \pythoninline{__str__} makes our output code far simpler when
printing objects.
...
% make forward, backward, ... some other common commands work on the whole group
% initializer: list of turtle objects
% default: a circle of turtles
% need __iter__ and __str__
